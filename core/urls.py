...
urlpatterns = [
    ...
    path('subir_nivel_cthulhu/<int:pk>/', views.ficha_cthulhu_upar, name='subir_nivel_cthulhu'),
    path('desmarcar/<int:id>/', views.desmarcar, name='desmarcar'),
    path('subir_nivel_habilidade/', views.subir_nivel_habilidade, name='subir_nivel_habilidade'),
