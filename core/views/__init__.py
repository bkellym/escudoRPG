...
from .view_ficha_cthulhu import ficha_cthulhu, check_campo_cthulhu, aumenta_pontos_vida, diminui_pontos_vida, aumenta_sanidade, diminui_sanidade
...
from .view_mesa import listar_mesas, listar_personagens_mesa