"""
Django settings for escudoRPG project.
...
SECRET_KEY = '^pzst4i1a_az(h$n!c69u^adrj!dgjevid5c4%*3+^a68u6mc2'
...
WSGI_APPLICATION = 'escudoRPG.wsgi.application'
